...
ninja.data = [{
    ...
    handler: () => {
      ...
      handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-our-paper-on-the-multisensor-home-dataset-was-accepted-in-pattern-recognition-if-9-1",
          title: 'Our paper on the MultiSensor-Home dataset was accepted in Pattern Recognition (IF: 9.1)....',
          description: "",
