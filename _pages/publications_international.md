...
<table class="service-table">
  ...
  <tr>
    ...
    <td class="content">
      ...
      <ul>
        <li>Minh Hieu Nguyen, Huu Tien Nguyen, <b>Trung Thanh Nguyen</b>, Manh Duong Nguyen, Trong Nghia Hoang, Truong Thao Nguyen, and Phi Le Nguyen, "FedCert: Federated Accuracy Certification," <i>In Proceedings of the 22nd IEEE International Symposium on Network Computing and Applications</i></li>
      </ul>
      <ul>
  ...
  <tr>
    ...
    <td class="content">
      ...
      <ul>
        <li>Hieu Dinh, Nang Hung Nguyen, <b>Trung Thanh Nguyen</b>, Thanh Hung Nguyen, Truong Thao Nguyen, and Phi Le Nguyen, "Deep Reinforcement Learning-based Offloading for Latency Minimization in 3-tier V2X Networks," <i>In Proceedings of the 2022 IEEE Wireless Communications and Networking Conference</i></li>
      </ul>
    </td>
  </tr>
